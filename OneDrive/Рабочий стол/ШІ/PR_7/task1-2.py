...
model = Sequential([
    Input(shape=(28, 28)),  # Вхідний шар з розміром зображення 28x28
    Reshape((28, 28, 1)),  # Перетворення вхідних даних на формування зображення (28, 28, 1)
    Flatten(),  # Розгортання вхідних даних перед передачею на повністю зв'язаний шар
    Dense(128, activation='relu'),  # Повністю зв'язаний шар з 128 нейронами та функцією активації ReLU
    Dense(10, activation='softmax')  # Вихідний шар з 10 нейронами та функцією активації softmax для класифікації
])
